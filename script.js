$(document).ready(function () {
    $("#patientFullName, #patientDOB, #evaluationDate, #notes").on("input", function () {
      updateView();
    });
    ...
    let diagnosisList = [
      {
        'code': 'F41.1',
        'template':'This is a template for the Generalized Anxiety Discordered clients'
      },
      {
        'code': 'F32.1',
        'template':'This is a template for the clients with Major Depressive Disorder'
      }
    ]
